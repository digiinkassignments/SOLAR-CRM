...
// Create User
// ===============================
const createUser = async (data, db = defaultDb) => {
...
// ===============================
const getAllUsers = async (offset, limit, search, role, status, db = defaultDb) => {
    const { whereClause, values } = buildUserQueryFilters(search, role, status);

    const query = `
        SELECT 
            u.id, u.role_id, u.full_name, u.username, u.email, u.phone,u.profile_image,
...
// ===============================
const getTotalUsersCount = async (search, role, status, db = defaultDb) => {
    const { whereClause, values } = buildUserQueryFilters(search, role, status);
...
// Get User By ID
// ===============================
const getUserById = async (id, db = defaultDb) => {
...
// ===============================
const checkUsernameExistsForUpdate = async (username, id, db = defaultDb) => {
...
// ===============================
const checkEmailExistsForUpdate = async (email, id, db = defaultDb) => {
...
// ===============================
const checkPhoneExistsForUpdate = async (phone, id, db = defaultDb) => {
...
// Update User
// ===============================
const updateUser = async (data, db = defaultDb) => {
...
// Update User Status
// ===============================
const updateUserStatus = async (id, status, db = defaultDb) => {
...
// ===============================
const getTeamMembersByManager = async (managerId, db = defaultDb) => {
    const query = `
        SELECT 
            u.id, 
            u.full_name, 
...
// ===============================
const isUserInManagerTeam = async (userId, managerId, db = defaultDb) => {
    const [rows] = await db.query(
