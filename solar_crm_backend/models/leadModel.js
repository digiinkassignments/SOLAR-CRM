...
// ======================================
const getLeads = async (params, roleId, userId, db = defaultDb) => {
  const {
...
// ======================================
const isLeadAccessibleByUser = async (leadId, roleId, userId, db = defaultDb) => {
  const role = Number(roleId);
...
// ======================================
const getTeamFollowupsList = async (managerId, db = defaultDb) => {
  const [rows] = await db.query(
    `
    SELECT
...
// ======================================
const updateLeadStatus = async (id, payload, performedBy, db = defaultDb) => {
...
// ======================================
const assignLead = async (id, assignedTo, assignedBy, db = defaultDb) => {
  const [currentRows] = await db.query(
...
// ======================================
const getFollowups = async (leadId, db = defaultDb) => {
  const [rows] = await db.query(
...
// 9. Get Activity Logs
// ======================================
const getActivityLogs = async (leadId, db = defaultDb) => {
  const [rows] = await db.query(
...
// 10. Soft Delete Lead
// ======================================
const deleteLead = async (id, deletedBy, db = defaultDb) => {
...
// ======================================
const bulkReassignLeads = async (fromUserId, toUserId, performedBy, db = defaultDb) => {
...
// ======================================
const bulkImportLeads = async (rows, createdBy, db = defaultDb) => {
