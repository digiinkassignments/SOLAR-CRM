...
const Users = () => {
  ...
  const fetchManagersDropdown = async () => {
    try {
      ...
      // Manager + Super Admin dono dikhao
      const filtered = data.filter(u => 
        u.role_id === ROLE_MANAGER || u.role_id === ROLE_SUPER_ADMIN
      );
  ...
  // Change 3 — handleOpenAddDrawer with user limit check
              ...
              <Box sx={{ p: 2.5, display: "flex", flexDirection: "column", gap: 2, flex: 1, overflowY: "auto" }}>
                ...
                <Box>
                  ...
                  >
                    ...
                    {/* Change 4 — Manager role hide karo if plan doesn't support it */}
